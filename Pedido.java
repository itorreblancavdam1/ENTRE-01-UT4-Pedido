...
public class Pedido
{
    ...
    public double  getImporteAntesIva() {
        double importeSinIva1;
        double importeSinIva2;
        importeSinIva1 = linea1.getProducto().getPrecio() * linea1.getCantidad();
        importeSinIva2 = linea2.getProducto().getPrecio() * linea2.getCantidad();
        return importeSinIva1 + importeSinIva1;
